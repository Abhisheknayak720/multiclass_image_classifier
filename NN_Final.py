...
def NN_model(X,Y, layers_dims, learning_rate ,beta, lambd, epochs , minibatch_size):
    ...
    # saving the parameters  (edited by abhishek)
    with open('trained_parameter_nature_and_others.pkl', 'wb') as f:
...
files = glob.glob ("D:/ml-test/Training_images/nature/resized/*.jpg")
files2 = glob.glob ("D:/ml-test/Training_images/other_except_nature/resized/*.jpg")
